...
First, load and clean the accelerometer data set named as "accel_data". In this step, we will change the variable names with more clear and meaningful titles, and also we will 
```{r}
accel_data_df = 
