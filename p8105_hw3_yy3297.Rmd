...
This data set contains `r nrow(ny_noaa)` rows and `r ncol(ny_noaa)` columns, and include `r colnames(ny_noaa)` variable. This data set have five core variables for all New York state weather stations from January 1, 1981 through December 31, 2010. 
